...
{
    public partial class frmCentroCosto : HerenciaVisual.frmMantenimiento, ICentroCostoView
    {
        CentroCostoEditor mPresenter;
        int mSelectCentroCostoID;

        #region . Constructor .

        private static frmCentroCosto _instance;
        public static frmCentroCosto GetInstance()
        {
            if (_instance == null || _instance.IsDisposed)
                _instance = new frmCentroCosto();
            _instance.BringToFront();
            return _instance;
        }

        private frmCentroCosto()
        {
            InitializeComponent();
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                base.OnLoad(e);
                this.mPresenter = new CentroCostoEditor(this);
            ...
            {
                MessageBox.Show(ErrorHandler.ObtenerMensajeError(ex, ModuloLog.Administracion, TipoObjeto.CentroCosto),
        ...
        #region . ICentroCostoView Members .
        ...
        public List<CentroCosto> DataSource
        {
            set
            {
        ...
        public List<CentroCosto> InactiveDataSource
        {
            set
            {
        ...
        public int SelectId
        {
            get { return this.mSelectCentroCostoID; }
        }
        ...
        public event EventHandler<EventArgs> SelectCentroCosto;
        ...
        public override void MostrarAyuda()
        {
            try
            {
                Help.ShowHelp(this, AppInfo.RutaAyuda, HelpNavigator.TopicId, "200");
            }
            catch (Exception ex)
            {
