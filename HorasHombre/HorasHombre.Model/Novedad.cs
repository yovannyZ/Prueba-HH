...
namespace HorasHombre.Model
{
    [Serializable()]
    [Title("Novedad")]
    public class Novedad : ModelBase, IDataErrorInfo, IComparable
    {
        private int id;
        ...
        {
            get { return tipoDistribucion; }
            set
            {
                if (tipoDistribucion == value) return;
                tipoDistribucion = value;
                this.NotifyPropertyChanged();
            }
        }
        ...
        {
            get { return aplicaCosto; }
            set
            {
                if (aplicaCosto == value) return;
                aplicaCosto = value;
                this.NotifyPropertyChanged();
            }
        }
