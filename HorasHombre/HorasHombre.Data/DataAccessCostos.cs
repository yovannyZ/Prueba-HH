...
{
    public abstract class DataAccessCostos
    {
        ...
        protected string ConnectionString
        {
            get
            {
                if (_cadenaConexion == null)
                {
                    ...
                    _cadenaConexion = string.Format("Data Source={0};Initial Catalog=BD_COS{1};User=miguel;password=main", ServerName, DataBaseName);
